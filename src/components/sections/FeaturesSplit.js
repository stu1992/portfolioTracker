          ...
          <div className={splitClasses}>
            ...
            <div className="split-item">
              <div className="split-item-content center-content-mobile reveal-from-left" data-reveal-container=".split-item">
                ...
                <p className="m-0">
                  A rising tide lifts all boats. Its not a moral virtue to not be able to support yourself.
                  </p>
              </div>
              <div className={
                classNames(
            ...
            <div className="split-item">
              <div className="split-item-content center-content-mobile reveal-from-left" data-reveal-container=".split-item">
                ...
                <p className="m-0">
                  You'll forget about this stuff in 2 days. Set yourself up for mini-wins that don't require heavy commitment.
                  </p>
              </div>
              <div className={
                classNames(
            ...
            <div className="split-item">
              <div className="split-item-content center-content-mobile reveal-from-right" data-reveal-container=".split-item">
                ...
                <p className="m-0">
                  Pay yourself first. Avoid lifestyle creep. Be happy with what you have and growing wealth will be effortless.
                  </p>
              </div>
              <div className={
                classNames(
